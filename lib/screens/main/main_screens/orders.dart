...
import 'package:medicare_admin/screens/main/details/order_detail.dart';
    ...
    return isShowUser
        ? StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance
                .collection("orders")
                .where("orderName", isGreaterThanOrEqualTo: controller.text)
                .snapshots(),
            builder:
                                      ...
                                      Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (builder) => OrderDetail(
                                                    name: documentData['name'],
                                                    orderName: documentData[
                                                        'orderName'],
                                                    price:
                                                        documentData['price'],
                                                    photoURL: documentData[
                                                        'photoURL'],
                                                    address:
                                                        documentData['address'],
                                                    quantity: documentData[
                                                        'quanrtity'],
                                                  )));
                                    },
                                    title: "View Detail"),
